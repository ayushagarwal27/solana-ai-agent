...
function formatSwapDetailsForDiscord(data, from: TokenInfo, to: TokenInfo) {
    ...
    return `${inAmount / Math.pow(10, from.decimals)} ${from.symbol} : ${outAmount / Math.pow(10, to.decimals)} ${to.symbol}`;
}
...
export const jupSwapInfo: Action = {
    ...
    examples: [
        ...
        [
            {
                user: "{{user1}}",
                content: { text: "How much EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v I can get for So11111111111111111111111111111111111111112 with 10% slippage" },
            },
            {
                user: "{{user2}}",
                content: {
        ...
        [
            {
                user: "{{user1}}",
                content: { text: "swap 100 DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263 to EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v with slipage 2 percent" },
            },
            {
                user: "{{user2}}",
                content: {
